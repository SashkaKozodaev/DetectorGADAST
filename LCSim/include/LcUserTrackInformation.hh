...
#ifndef LcUserTrackInformation_h
#define LcUserTrackInformation_h 1

enum LcTrackStatus { active=1, //hitPMT=2, 
                   absorbed=4, boundaryAbsorbed=8,//hitSphere=16, 
           inactive=14};
...
class LcUserTrackInformation : public G4VUserTrackInformation
{
public:
  LcUserTrackInformation();
  ~LcUserTrackInformation();
