...
#ifndef LcPhotonCounterSD_h
#define LcPhotonCounterSD_h 1
...
class LcPhotonCounterSD : public G4VSensitiveDetector
{
    public:
        LcPhotonCounterSD(G4String);
        ~LcPhotonCounterSD();
    ...
    private:
        LcPMTHitsCollection* fPhotonCounterHitCollection;
